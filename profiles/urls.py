...
from .views import RegisterView, ProfileSearchView, FollowProfileView, UnfollowProfileView, FollowListView
urlpatterns = [
    ...
    path('followed-list/', FollowListView.as_view(), name='followed-list')
]
